...
from custom_sih import  get_files_to_download
import subprocess
import os
...
ftp_files = get_files_to_download(state,year, month)
print(ftp_files)

for file_group in ftp_files:
    for ftp_file in file_group['ftp_paths']:
        # get files from FTP
        output_dbc = subprocess.check_output(['/home/developer/pysus/auto-get-files/collect_from_ftp.sh',ftp_file,dbc_dir])
